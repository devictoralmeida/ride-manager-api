...
export class UpdateEntitiesConstructor1695242996691
  implements MigrationInterface
{
  name = 'UpdateEntitiesConstructor1695242996691'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "specifications_cars" ADD CONSTRAINT "PK_63472a3f9ebc2f9ea4f3e89540e" PRIMARY KEY ("car_id", "specification_id")`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "cars_image" ADD CONSTRAINT "FK_3bf362d0f4796d2ab4b520fc405" FOREIGN KEY ("car_id") REFERENCES "cars"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "cars_image" DROP CONSTRAINT "FK_3bf362d0f4796d2ab4b520fc405"`,
    )
    await queryRunner.query(
